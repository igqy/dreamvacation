    ...
    $.extend({
        backToTopLink: function (options) {
            ...
            var settings = $.extend({
				...
				navigatorBgcolor		: '#322A61',				//navigator background color
				navigatorBgcolorHover	: '#231D43',				//navigator background color (when hovering, by default same color)
				...
				arrowColor	 			: '#b5b1d0',				//color of the div arrow
